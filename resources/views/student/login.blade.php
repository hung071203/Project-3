        ...
        <div class="row w-100">
            <div class="col-lg-4 mx-auto">
                <div class="auto-form-wrapper">
                    <form action="{{ route('student.loginProcess') }}" method="post">
                        @if (session('error'))
                ...
                <span class="input-group-text">
                  <i class="mdi mdi-check-circle-outline"></i>
                        ...
                        <div class="form-group">
                            <button class="btn btn-primary submit-btn btn-block">Login as Student</button>
                        </div>
                        <div class="form-group d-flex justify-content-between">
                            <div class="form-check form-check-flat mt-0">
                                ...
                                {{--                                    <input type="checkbox" class="form-check-input" checked> Keep me signed in </label>--}}
                                                        ...
                                                        <a href="{{ route('student.forgotPassword') }}" class="text-small forgot-password text-black">Forgot Password</a>
                        </div>
                        {{--                        <div class="form-group">--}}
